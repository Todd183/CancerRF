...
Air quality data was collected from Land, Air, Water Aotearoa (LAWA). The original dataset provides latitude and longitude coordinates, monitoring site names, as well as concentrations of PM10 and PM2.5 from 2016 to 2022. PM10 particles have a diameter of less than 10 micrometers (µm), while PM2.5 particles are under 2.5 µm in diameter (LAWA). We have converted the latitude and longitude coordinates into DHB regions and limited the time frame of our analysis to the years 2016 to 2020. Inhaling clean air is essential for our health (LAWA). It is vital to consider air quality as a factor related to cancer incidence for analysis.

#### 2.1.2.3 Groundwater quality

The data was also obtained from LAWA and encompasses groundwater quality monitoring in New Zealand from 2004 to 2021. Five indicators are utilized to assess groundwater quality, including the values of Chloride, Dissolved Reactive Phosphorus, Escherichia Coli, Electrical Conductivity, and Nitrate Nitrogen. The latitude and longitude information in the original dataset was converted into DHB regions, covering the period from 2011 to 2020. The LAWA states that the groundwater is commonly utilized as an origin of drinking water. Therefore, we adopt this as an environmental risk factor related to cancer incidence.
...
#### 3.1.3 Distribution in Detailed Observations
...
**Data Preprocessing**: We chose suitable techniques to address and manage missing data, ensuring data completeness, reencode region names for consistency and comparability across the datasets, Merge environmental data to derive aggregated statistical features for enhanced analysis support.

**Geospatial Data Handling**: We converted geographical coordinates into DHB (District Health Board) regions with GIS data, providing a more accurate representation of the geographic impact on the study.

**Statistical Analysis**: We quantified the strength and direction of relationships between variables by calculating Pearson correlation coefficients. Simultaneously, significance testing was conducted using ANOVA to assess the significance of relationships. To account for multiple comparisons across various feature types and ensure the reliability of our findings, we implemented the 'Holm' method to adjust p-values. 

**Visualization Techniques**: Visualizations such as volcano plots and scatter plots were developed to effectively communicate the relationships identified during the study.

**Leveraging Data Processing Tools**: We used various packages, including 'tidyverse,' 'sf,' 'tools,' and 'ComplexHeatmap,' to facilitate data processing and visualization tasks, improving the efficiency of our processes and enhancing the clarity of our results.
